@if ($paginator->hasPages())
    <nav role="navigation" aria-label="{{ __('Pagination Navigation') }}" id='amogus' class="flex items-center justify-between">
        ...
        <div class="hidden sm:flex-1 sm:flex sm:items-center sm:flex-col sm:justify-around">
            <div>
                <p class="text-sm text-gray-700 leading-5 dark:text-gray-400 my-7">
                    {!! __('Showing') !!}
