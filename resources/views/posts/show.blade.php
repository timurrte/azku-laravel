<x-app-layout>
    ...
    <div class="py-4">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 mt-4">
            ...
            <form action="post" action={{route("posts.delete", $post->id)}}>
                @csrf
                @method('delete')
                <button type="submit" class="focus:outline-none mt-5 ml-10 text-white bg-red-700 hover:bg-red-800 focus:ring-4 focus:ring-red-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 dark:bg-red-600 dark:hover:bg-red-700 dark:focus:ring-red-900">DELETE</button>
            </form>
        </div>
